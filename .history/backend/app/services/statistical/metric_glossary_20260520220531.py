...
METRIC_GLOSSARY = {
    "true_positive": {
        ...
        "explanation": "Correctly flagged positive cases (e.g., fraud detected when it was actually fraud).",
    },
    "true_negative": {
        "short_label": "True Negative (TN)",
        "explanation": "Correctly cleared negative cases (e.g., legitimate transaction correctly approved).",
    },
    "false_positive": {
    ...
    "false_negative": {
        ...
        "explanation": "Missed case — predicted negative but the actual outcome was positive (missed fraud).",
    },
    "accuracy": {
